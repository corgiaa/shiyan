...
# ==========================================
# Adapter module has been removed
# ==========================================


# ==========================================
# Original Block Module (without Adapters)
# ==========================================
class Block(nn.Module):
    def __init__(self, config, vis):
        ...
        # Adapters removed from here

    def forward(self, x):
        h = x
        x = self.attention_norm(x)
        attn_output, weights = self.attn(x)
        # Adapter application removed
...
# ==========================================
# Modified Embeddings Module (without MCAA)
# ==========================================
class Embeddings(nn.Module):
    def __init__(self, config, img_size, in_channels=3):
        ...
        # ==========================================
        # MCAA instantiation removed from here
        # ==========================================
    ...
    def forward(self, x):
        ...
        # MCAA application and associated reshaping removed.
        # x_resnet (B, C, H, W) now directly goes into patch_embeddings.
        x = self.patch_embeddings(x_resnet) # This expects (B, C, H, W)
        x = x.flatten(2)
        x = x.transpose(-1, -2)
